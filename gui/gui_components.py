from gui.gui_helpers import ( # gui.gui_helpers
    # simulate_data_dist,
...
import numpy as np
from gui.gui_strings import GUIStrings # gui.gui_strings
import re
...
class GUIComponents:
    ...
    def markValueForCorrelatedId(self, correlatedId, value: bool):
