...
def createMainEffectsChecklistCallbacks(app, comp: GUIComponents = None):
    ...
    inputs = [Input(id, "value") for id in mainEffectCompIds]
    ...
    def addVariables(*args):
        ...
        for i in range(len(inputs)):
            id = states[i]
            value = inputs[i]
            if value and comp.hasMainEffectForComponentId(id):
                ...
                pass
            elif not value and comp.hasMainEffectForComponentId(id):
                mainEffect = comp.getMainEffectFromComponentId(id)
...
def createInteractionEffectsChecklistCallbacks(app, comp: GUIComponents = None):
    ...
    if comp and comp.hasInteractionEffects():
        ...
        inputs = [Input(id, "value") for id in interactionEffectCompIds]
        ...
        def addVariables(*args):
            ...
            for i in range(len(inputs)):
                id = states[i]
                value = inputs[i]
                if value and comp.hasInteractionEffectForComponentId(id):
                    ...
                    pass
                elif not value and comp.hasInteractionEffectForComponentId(id):
                    interactionEffect = comp.getInteractionEffectFromComponentId(id)
