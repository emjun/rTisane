...
setGeneric("checkAndRefineConceptualModel", function(conceptualModel, iv, dv) standardGeneric("checkAndRefineConceptualModel"))
setMethod("checkAndRefineConceptualModel", signature("ConceptualModel", "missing", "missing"), function(conceptualModel, iv, dv)
{
...
setMethod("checkAndRefineConceptualModel", signature("ConceptualModel", "AbstractVariable", "AbstractVariable"), function(conceptualModel, iv, dv)
{
  ### Step 0: Construct causal graph from declared relationships in ConceptualModel
  conceptualModel@graph <- updateGraph(conceptualModel)
